...
describe("Jwt Auth Credentials API", function()
  ...
  describe("/consumers/:consumer/jwt-auth/", function()
    ...
    setup(function()
      ...
      BASE_URL = spec_helper.API_URL.."/consumers/bob/jwt-auth/"
    end)

    describe("POST", function()

      it("[SUCCESS] should create a jwt-auth credential", function()
  ...
  describe("/consumers/:consumer/jwt-auth/:id", function()
